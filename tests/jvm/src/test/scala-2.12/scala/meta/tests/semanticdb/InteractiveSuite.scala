...
class InteractiveSuite extends FunSuite {
  ...
  check(
    """
      |class SelfType { this: Map[String, Int] => }
      |object X{
    ...
    """|interactive.scala
       ...
       |
       |Symbols:
       |_empty_/SelfType# => class SelfType extends AnyRef { self: Map[String, Int] => +1 decls }
       |  AnyRef => scala/AnyRef#
       |  Map => scala/Predef.Map#
       |  String => scala/Predef.String#
       |  Int => scala/Int#
       |_empty_/SelfType#`<init>`(). => primary ctor <init>()
       |
       |Occurrences:
       |[1:6..1:14): SelfType <= _empty_/SelfType#
       |[1:15..1:15):  <= _empty_/SelfType#`<init>`().
       |[0:23..0:26): Map => scala/collection/immutable/Map#
       |[0:27..0:33): Int => scala/Int#
       |[0:36..0:39): String => java/lang/String#
       |
    """.stripMargin
  )
}
